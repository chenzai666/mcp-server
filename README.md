...
说明
web_search 会按 SEARCH_BACKENDS 顺序搜索，推荐：tavily,searxng,duckduckgo
没有配置 TAVILY_API_KEY 时，会自动回退到后面的搜索后端
image_describe 没配置 VISION_API_URL 时，会回退为“图片基础信息 + OCR 文本”模式
youtube_transcript 依赖公开视频存在字幕
